...
public class MenuLabelPrinter extends Activity implements ButtonEventListener, UserAdapter.OnClickButtonListener {
    ...
    public void onClickNavigationbarButton(int buttonId, boolean isLongClick) {
        switch (buttonId){
            case ActionButtonbarFragment.BUTTON_ADD:
                Intent intent = new Intent(MenuLabelPrinter.this,RegisterActivity.class);
    ...
    public void onClickButtonDelete(final User user) {
        if(user.getIsAdmin()){
            Toast.makeText(MenuLabelPrinter.this, "Admin account can not be deleted", Toast.LENGTH_LONG).show();
            return;
        }
            ...
            try
            {
                ...
                dialogButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        DatabaseService db = new DatabaseService(MenuLabelPrinter.this);
                        db.deleteUser(user);
                        adapter.remove(user);
                        adapter.notifyDataSetChanged();
                        dialog.dismiss();
