...
public class SettingsFactoryResetActivity extends FragmentActivity implements  ButtonEventListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		navigationbar.getTextTitle().setText(getString(R.string.factory_reset).toUpperCase());
	...
	protected void onResume() {
		...
		getSupportFragmentManager().beginTransaction().replace(R.id.settings_unit_container_fragment, new SettingsFactoryResetFragment()).commit();
	}
