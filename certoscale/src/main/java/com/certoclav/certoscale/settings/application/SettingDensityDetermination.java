...
public class SettingDensityDetermination extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getPreferenceScreen().findPreference(getString(R.string.preferences_density_lock)).setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
