...
public class SettingPipetteAdjustment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getPreferenceScreen().findPreference(getString(R.string.preferences_pipette_lock)).setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
