...
public class MenuItemEditActivity extends Activity implements ItemAdapter.OnClickButtonListener, ButtonEventListener{
    ...
    @Override
    public void onClickButtonSave(final Item item) {
        try
        {
            ...
            text.setText("Do you really want to save the item? " + item.getName());
            ...
            dialogButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Item newItem = new Item("",item.getName(), item.getWeight(), item.getItemArticleNumber());
