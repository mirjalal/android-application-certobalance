...
public class ApplicationFragmentWeight extends Fragment implements ValueTransformedListener{
    ...
    public void onValueTransformedChanged(Float value) {
        textValue.setText(String.format("%.5f", value - Scale.getInstance().getTara()) + " " + Scale.getInstance().getUnitTransformed());
        ...
        textSum.setText("SUM: " + String.format("%.5f",Scale.getInstance().getScaleValueRaw()) + " "+ Scale.getInstance().getUnitTransformed());
