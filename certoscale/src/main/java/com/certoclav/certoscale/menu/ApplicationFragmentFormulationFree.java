...
public class ApplicationFragmentFormulationFree extends Fragment implements RecipeEntryListener  {
    ...
    public void onResume() {
        ...
        if(ApplicationManager.getInstance().getCurrentRecipe()!= null){
           if(ApplicationManager.getInstance().getCurrentRecipe().getRecipeEntries().isEmpty() == false) {
               ...
               Scale.getInstance().setScaleApplication(ScaleApplication.FORMULATION_FREE);
