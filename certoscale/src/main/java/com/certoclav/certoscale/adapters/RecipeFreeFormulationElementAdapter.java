 ...
 *
 */
public class RecipeFreeFormulationElementAdapter extends ArrayAdapter<RecipeEntry> {
    ...
    public RecipeFreeFormulationElementAdapter(Context context, List<RecipeEntry> values) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.menu_main_free_formulation_element, parent, false);
        ...
        editWeight.setText(String.format("%.4f",getItem(position).getWeight())+" g");
