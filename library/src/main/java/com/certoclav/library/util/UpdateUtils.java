 ...
 */
	...
	//		2) Lade Liste von aktuellen download-files vom server (falls nicht mlich errormeldung - exit)
	//		3) Vergleiche Liste mit existierenden Dateien im Download-Verzeichnis:
	//		Falls apk Datei komplett neu: Lade herunter und kopiere in /system/app
		//		Falls apk Datei neuer als aktuelle: Lade herunter und installiere
		//		Falls mp4 Datei komplett neu: Lade herunter in Download-Ordner
		//		Falls mp4 Datei neuer als aktuelle: Lade herunter in Download-Ordner
